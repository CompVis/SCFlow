...
class FrozenOpenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, arch="ViT-H-14", version="laion2b_s32b_b79k", device="cuda", max_length=77,
        ...
        assert layer in self.LAYERS
        # try:
        #     # force to load the local file instead of checking everytime with hub
        #     model, _, _ = open_clip.create_model_and_transforms(arch, device=torch.device('cpu'), pretrained="/p/scratch/degeai/ma10/cache/huggingface/hub/models--laion--CLIP-ViT-H-14-laion2B-s32B-b79K.bin")
